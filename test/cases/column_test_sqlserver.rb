...
class ColumnTestSqlserver < ActiveRecord::TestCase
  ...
  context 'For binary columns' do
    ...
    setup do
      @binary_string = "GIF89a\001\000\001\000\200\000\000\377\377\377\000\000\000!\371\004\000\000\000\000\000,\000\000\000\000\001\000\001\000\000\002\002D\001\000;".force_encoding(Encoding::ASCII_8BIT)
